package com.example.administrator.sqlitedemo32;
...
public class MainActivity extends AppCompatActivity{
    ...
    String db_path = "data/data/com.example.administrator.sqlitedemo32/database/";//数据库路径，本程序的专属目录 data/data/本程序的包名/database
    //数据库字段名
